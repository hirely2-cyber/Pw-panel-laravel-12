...
<div class="pw-auth-site-footer">
    ...
    @endphp
    @if($waLink || $fbLink || $discordLink)
    <div class="pw-auth-site-footer__social">
        @if($waLink)
        <a href="https://wa.me/{{ $waLink }}" target="_blank" rel="noopener" title="WhatsApp">
        ...
        @endif
        @if($fbLink)
        <a href="{{ $fbLink }}" target="_blank" rel="noopener" title="Facebook">
        ...
        @endif
        @if($discordLink)
        <a href="{{ $discordLink }}" target="_blank" rel="noopener" title="Discord">
