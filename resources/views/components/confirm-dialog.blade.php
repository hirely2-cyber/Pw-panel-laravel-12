{{--
    ...
    Usage: @include('components.confirm-dialog') di layout atau halaman manapun

    Cara pakai di form / button:
      <form data-confirm="Judul|Pesan konfirmasi" ...>
      <button data-confirm="Judul|Pesan konfirmasi" ...>

    Default variant = danger. Variant lain:
      data-confirm-variant="success"   → tombol hijau (Approve)
      data-confirm-variant="warning"   → tombol kuning
      data-confirm-variant="danger"    → tombol merah (default)

    Custom label tombol OK:
      data-confirm-ok="Ya, Approve"

    Contoh lengkap:
      <form method="POST" action="..."
            data-confirm="Approve Invoice|Kredit 500 gold ke user orion?"
