...
@section('title', 'Top-up Gold Points — ' . $__siteName)
@section('meta_description', 'Top-up Gold Points dengan QRIS, bayar otomatis & instan.')
...
<section class="pw-section">
    <div class="pw-section__inner pw-section__inner--narrow">
        ...
        <form method="POST" action="{{ route('donate.invoice') }}" id="donate-form">
            @csrf
            ...
            <div class="pw-donate-section-title">
                <img src="{{ asset('images/gif_icon/web_coin.gif') }}" alt="" width="20">
            ...
            <div class="pw-donate-grid" x-data="{ selected: null }">
                ...
                <label class="pw-donate-pkg-wrap">
                    <input type="radio" name="package" value="{{ $key }}" required
                           ...
                           x-model="selected"
                           @change="selected = '{{ $key }}'">
                    <div class="pw-donate-pkg" :class="selected === '{{ $key }}' ? 'is-selected' : ''">
                        <div class="pw-donate-pkg__coin" aria-hidden="true">
                            <img src="{{ asset('images/gif_icon/web_coin.gif') }}" alt="Gold Points" width="36">
                        </div>
                        <div class="pw-donate-pkg__row">
                            <span class="pw-donate-pkg__row-label">Donasi Gold Points</span>
                            <span class="pw-donate-pkg__row-val">{{ number_format($pkg['gold']) }}</span>
                        </div>
                        <div class="pw-donate-pkg__row pw-donate-pkg__row--bonus">
                            <span class="pw-donate-pkg__row-label">Bonus</span>
                            <span class="pw-donate-pkg__row-bonus">+{{ number_format($pkg['bonus']) }} Gold Points</span>
                        </div>
                        <div class="pw-donate-pkg__row pw-donate-pkg__row--total">
                            <span class="pw-donate-pkg__row-label">Total Diterima</span>
                            <span class="pw-donate-pkg__row-total">{{ number_format($pkg['gold'] + $pkg['bonus']) }} Gold Points</span>
                        </div>
                        <div class="pw-donate-pkg__row" style="margin-top:.9rem;padding-top:.75rem;border-top:1px solid rgba(255,255,255,.06);">
                            ...
                            <span class="pw-donate-pkg__row-price">Rp {{ number_format($pkg['price_idr']) }}</span>
                        </div>
            ...
            <div style="margin-top:1.8rem;">
                <button type="submit" class="pw-btn pw-btn--gold pw-btn--lg" style="width:100%;justify-content:center;">
                    <img src="{{ asset('images/gif_icon/web_coin.gif') }}" alt="" width="16" style="vertical-align:middle;">
                    Donate Gold Points
                </button>
            </div>
