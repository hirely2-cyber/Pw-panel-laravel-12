...
<div style="display:grid;gap:1rem;">
    ...
    <div class="pw-adm-card" style="padding:1rem 1.2rem;">
        ...
        <form id="df-upload-form" method="POST" action="{{ route('gm.datafile-control.upload') }}" enctype="multipart/form-data" style="display:grid;gap:.8rem;max-width:760px;">
            @csrf
    ...
    <div class="pw-adm-card" style="padding:1rem 1.2rem;">
        ...
        <form id="ng-upload-form" method="POST" action="{{ route('gm.datafile-control.npcgen') }}" enctype="multipart/form-data" style="display:grid;gap:.8rem;max-width:760px;">
            @csrf
            <div>
