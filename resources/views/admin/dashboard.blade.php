...
<div class="pw-adm-stats-row" style="display:grid;grid-template-columns:repeat(4,1fr);gap:1rem;margin-bottom:1.5rem;">
    <div class="pw-adm-stat">
        ...
        <div class="pw-adm-stat__value">Rp {{ number_format($stats['total_income']) }}</div>
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem;">
    ...
    <div class="pw-adm-card">
            ...
            <table class="pw-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="color:var(--pw-text-muted);font-size:.78rem;">{{ $inv->created_at->diffForHumans() }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
        ...
        <div style="margin-top:.8rem;">
            <a href="{{ route('admin.donate') }}" class="pw-adm-btn pw-adm-btn--sm pw-adm-btn--ghost">Lihat Semua →</a>
        </div>
        @endif
    </div>
    ...
    <div class="pw-adm-card">
        ...
        <div style="margin-top:.8rem;">
            <a href="{{ route('admin.shop.index') }}" class="pw-adm-btn pw-adm-btn--sm pw-adm-btn--ghost">Ke Item Shop →</a>
        </div>
        @endif
    </div>
