    ...
    <div class="pw-section__inner pw-section__inner--narrow">
        ...
        <div style="position:relative;text-align:center;padding:2.5rem 1rem;background:radial-gradient(ellipse at center,rgba(200,151,42,.08) 0%,transparent 70%);border-radius:14px;margin-bottom:1.5rem;">
            ...
            <div style="font-size:clamp(.85rem,2.5vw,1.05rem);color:var(--pw-text-muted);margin-top:.5rem;line-height:1.5;">
                Berupa <span style="color:#fbbf24;font-weight:700;">{{ number_format($totalCubi) }} Cubi Gold</span> per orang (maks.)
            </div>
        ...
        <div class="pw-card" style="padding:1.5rem;margin-bottom:2rem;">
            ...
            <div style="text-align:center;margin-top:1rem;font-size:.78rem;color:var(--pw-text-muted);">
                ...
                Konversi: 1 Cubi Gold = Rp 1.000 &bull; Syarat: Karakter min. Level {{ $reqLevel }}
            </div>
        </div>
                ...
                <div style="font-size:.88rem;color:var(--pw-text-light);line-height:1.8;text-align:left;">
                    ...
                    <div style="margin-bottom:1.2rem;">
                        ...
                        <div style="padding-left:2.5rem;">
                            Daftar Akun kamu di Website Resmi <strong style="color:#fbbf24;">{{ $__siteName }}</strong> pada saat masa Event berlangsung.
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom:1.2rem;">
                        ...
                        <div style="padding-left:2.5rem;">
                            Salin kode referral kamu yang dapat kamu temukan di <a href="{{ route('profile') }}" style="color:#fbbf24;text-decoration:underline;">halaman profil</a>.
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom:1.2rem;">
                        ...
                        <div style="padding-left:2.5rem;">
                            Teman kamu mendaftar menggunakan link referral kamu dan membuat karakter di ID yang terdaftar pada saat CBT, lalu mencapai <strong style="color:#fbbf24;">Level {{ $reqLevel }}</strong>. Maka secara otomatis akan valid ke dalam sistem.
                        </div>
                    </div>
