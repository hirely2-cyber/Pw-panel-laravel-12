    ...
    <div style="text-align:center;max-width:600px;animation:fadeIn .6s ease-out;">
        ...
        <div style="display:flex;gap:1rem;justify-content:center;flex-wrap:wrap;margin-top:2rem;">
            ...
            <a href="{{ route('dashboard') }}" class="pw-btn pw-btn--ghost">
                ...
                {{ __('main.nav_dashboard') ?? 'Dashboard' }}
            </a>
            @else
            <a href="{{ route('login') }}" class="pw-btn pw-btn--ghost">
        ...
        <p style="color:var(--pw-text-muted);font-size:0.82rem;margin-top:2.5rem;line-height:1.8;">
            {{ __('main.error_404_help') }}<br>
            <a href="https://wa.me/{{ \App\Models\Setting::get('social_whatsapp') }}" style="color:#c49d6d;text-decoration:none;" target="_blank" rel="noopener">
                {{ __('main.error_404_contact') }} →
            </a>
        </p>
    </div>
</div>
