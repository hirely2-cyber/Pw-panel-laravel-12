...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cinzel:wght@400;600;700;900&family=Exo+2:wght@300;400;500;600;700&display=swap" rel="stylesheet">
...
<body class="pw-body">
    ...
    <nav class="pw-mobile-nav" aria-label="Mobile navigation">
        ...
        <a href="{{ route('donate') }}" class="pw-mobile-nav__item {{ request()->routeIs('donate') ? 'pw-mobile-nav__item--active' : '' }}">
