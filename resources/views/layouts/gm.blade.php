...
<head>
    ...
    <title>@yield('title', 'GM Panel') — {{ $__siteName }}</title>
...
<body class="pw-body pw-admin-body">
    ...
    <aside class="pw-adm-sidebar" id="adminSidebar">
        <div class="pw-adm-sidebar__head">
            <a href="{{ route('gm.dashboard') }}" class="pw-adm-sidebar__brand">
        ...
        <nav class="pw-adm-nav">
            ...
            <a href="{{ route('gm.dashboard') }}" class="pw-adm-nav__item {{ request()->routeIs('gm.dashboard') ? 'is-active' : '' }}">
            ...
            <a href="{{ route('gm.articles.index') }}" class="pw-adm-nav__item {{ request()->routeIs('gm.articles*') ? 'is-active' : '' }}">
            ...
            <a href="{{ route('gm.server-control') }}" class="pw-adm-nav__item {{ request()->routeIs('gm.server-control*') ? 'is-active' : '' }}">
            ...
            @if(Route::has('gm.datafile-control'))
            <a href="{{ route('gm.datafile-control') }}" class="pw-adm-nav__item {{ request()->routeIs('gm.datafile-control*') ? 'is-active' : '' }}">
            ...
            @endif
            <a href="{{ route('gm.ranking') }}" class="pw-adm-nav__item {{ request()->routeIs('gm.ranking*') ? 'is-active' : '' }}">
            ...
            <a href="{{ route('gm.members.index') }}" class="pw-adm-nav__item {{ request()->routeIs('gm.members*') ? 'is-active' : '' }}">
            ...
            <a href="{{ route('gm.cubi-monitor') }}" class="pw-adm-nav__item {{ request()->routeIs('gm.cubi-monitor*') ? 'is-active' : '' }}">
