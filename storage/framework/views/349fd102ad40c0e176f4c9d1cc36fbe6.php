<?php $__env->startSection('title', 'Konfigurasi Panel'); ?>

<?php $__env->startSection('content'); ?>


<div style="display:flex;gap:.5rem;margin-bottom:1.25rem;">
    <a href="<?php echo e(route('admin.settings')); ?>" class="pw-btn pw-settings-tab--inactive" style="font-size:.8rem;padding:.45rem .9rem;">
    ...
    <a href="<?php echo e(route('admin.settings.panel')); ?>" class="pw-btn pw-btn--gold" style="font-size:.8rem;padding:.45rem .9rem;">
...
<form action="<?php echo e(route('admin.settings.panel.update')); ?>" method="POST">
    <?php echo csrf_field(); ?>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
            <div class="pw-form__group">
                ...
                <input type="text" name="server_version" class="pw-form__input"
                    value="<?php echo e($settings->get('server_version', '1.5.5')); ?>"
                    placeholder="Contoh: 1.5.5">
                <p class="pw-form__hint">Versi server yang ditampilkan di topbar website.</p>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['server_version'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="pw-adm-card" style="margin-bottom:1.25rem;">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(260px,1fr));gap:.7rem;">
            ...
            <label class="pw-feat-toggle <?php echo e($isOn ? 'is-on' : ''); ?>" style="display:flex;align-items:center;justify-content:space-between;gap:.8rem;padding:.75rem 1rem;border-radius:8px;cursor:pointer;">
                <div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pw-panel/resources/views/admin/settings/panel.blade.php ENDPATH**/ ?>