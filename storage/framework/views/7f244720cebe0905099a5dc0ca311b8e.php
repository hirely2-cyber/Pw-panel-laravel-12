<?php $__env->startSection('title', 'DATAFILE Control'); ?>
    ...
    <div class="pw-adm-card" style="padding:1rem 1.2rem;">
        <div style="display:flex;justify-content:space-between;gap:1rem;flex-wrap:wrap;align-items:center;">
            <div>
                ...
                <div style="font-family:monospace;font-size:.9rem;color:var(--pw-text-light);"><?php echo e($datafilePath); ?></div>
                <div style="font-size:.75rem;color:var(--pw-text-muted);margin-top:.2rem;">Script: <?php echo e($replaceScript); ?></div>
            </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canEditPath): ?>
            <form method="POST" action="<?php echo e(route('admin.datafile-control.path')); ?>" style="margin-top:.9rem;display:flex;gap:.6rem;flex-wrap:wrap;align-items:center;">
                <?php echo csrf_field(); ?>
                <input type="text" name="datafile_path" value="<?php echo e($datafilePath); ?>"
                       class="df-input"
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['datafile_path'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                <div style="font-size:.78rem;color:#ef4444;margin-top:.45rem;"><?php echo e($message); ?></div>
            <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="pw-adm-card" style="padding:1rem 1.2rem;">
        ...
        <form id="df-upload-form" method="POST" action="<?php echo e(route('admin.datafile-control.upload')); ?>" enctype="multipart/form-data" style="display:grid;gap:.8rem;max-width:760px;">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <div x-data="{ open: false, targetFile: <?php echo \Illuminate\Support\Js::from($selectedTarget)->toHtml() ?> }" style="position:relative;" @click.away="open = false">
                    ...
                    <div x-show="open" x-transition.opacity.duration.150ms class="df-dropdown-menu">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $allowedFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <button type="button"
                                    @click="targetFile = <?php echo \Illuminate\Support\Js::from($name)->toHtml() ?>; open = false"
                                    class="df-dropdown-item"
                                    :class="targetFile === <?php echo \Illuminate\Support\Js::from($name)->toHtml() ?> && 'df-dropdown-item--active'"><?php echo e($name); ?></button>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['target_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    <div style="font-size:.78rem;color:#ef4444;margin-top:.35rem;"><?php echo e($message); ?></div>
                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['datafile'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="pw-adm-card" style="padding:1rem 1.2rem;">
        <div style="display:flex;justify-content:space-between;gap:1rem;flex-wrap:wrap;align-items:center;">
            <div>
                ...
                <div style="font-family:monospace;font-size:.9rem;color:var(--pw-text-light);"><?php echo e($worldPath); ?>/npcgen.data</div>
                <div style="font-size:.75rem;color:var(--pw-text-muted);margin-top:.2rem;">Script: <?php echo e($npcgenScript); ?></div>
            </div>
    ...
    <div class="pw-adm-card" style="padding:1rem 1.2rem;">
        ...
        <form id="ng-upload-form" method="POST" action="<?php echo e(route('admin.datafile-control.npcgen')); ?>" enctype="multipart/form-data" style="display:grid;gap:.8rem;max-width:760px;">
            <?php echo csrf_field(); ?>
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['npcgen_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
    ...
    <div class="pw-adm-card" style="padding:1rem 1.2rem;">
        ...
        <div style="overflow:auto;">
            <table style="width:100%;border-collapse:collapse;min-width:700px;">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $npcgenLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            ...
                            <td style="padding:.55rem;border-bottom:1px solid var(--pw-border);font-size:.78rem;"><?php echo e($row->original_name ?: '-'); ?></td>
                            <td style="padding:.55rem;border-bottom:1px solid var(--pw-border);font-size:.78rem;text-align:right;"><?php echo e(number_format((int) $row->file_size)); ?></td>
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            ...
                            <td style="padding:.55rem;border-bottom:1px solid var(--pw-border);font-size:.78rem;"><?php echo e($row->actor_name); ?></td>
                            <td style="padding:.55rem;border-bottom:1px solid var(--pw-border);font-size:.78rem;text-transform:uppercase;"><?php echo e($row->actor_role); ?></td>
                            <td style="padding:.55rem;border-bottom:1px solid var(--pw-border);font-size:.78rem;font-family:monospace;"><?php echo e($row->target_file); ?></td>
                            <td style="padding:.55rem;border-bottom:1px solid var(--pw-border);font-size:.78rem;"><?php echo e($row->original_name ?: '-'); ?></td>
                            <td style="padding:.55rem;border-bottom:1px solid var(--pw-border);font-size:.78rem;text-align:right;"><?php echo e(number_format((int) $row->file_size)); ?></td>
                            <td style="padding:.55rem;border-bottom:1px solid var(--pw-border);font-size:.78rem;">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row->status === 'success'): ?>
                            ...
                            <td style="padding:.55rem;border-bottom:1px solid var(--pw-border);font-size:.74rem;color:var(--pw-text-muted);max-width:320px;word-break:break-word;"><?php echo e($row->script_output ?: '-'); ?></td>
                        </tr>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        <tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pw-panel/resources/views/admin/datafile-control.blade.php ENDPATH**/ ?>