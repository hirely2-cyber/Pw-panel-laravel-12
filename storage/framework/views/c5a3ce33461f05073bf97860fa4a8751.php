...
<div style="display:grid;gap:1rem;">
    ...
    <div class="pw-adm-card" style="padding:1rem 1.2rem;">
        <div style="display:flex;justify-content:space-between;gap:1rem;flex-wrap:wrap;align-items:center;">
            ...
            <div style="padding:.35rem .6rem;border-radius:6px;background:rgba(245,158,11,.12);border:1px solid rgba(245,158,11,.3);font-size:.74rem;color:#f59e0b;">
                Setelah update DATAFILE, restart server game wajib dilakukan
            </div>
        </div>
    </div>
    ...
    <div class="pw-adm-card" style="padding:1rem 1.2rem;">
        ...
        <form id="df-upload-form" method="POST" action="<?php echo e(route('gm.datafile-control.upload')); ?>" enctype="multipart/form-data" style="display:grid;gap:.8rem;max-width:760px;">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div style="display:flex;gap:.6rem;align-items:center;flex-wrap:wrap;">
                ...
                <span style="font-size:.74rem;color:var(--pw-text-muted);">Pastikan file update sesuai build server yang aktif.</span>
            </div>
    ...
    <div class="pw-adm-card" style="padding:1rem 1.2rem;">
        ...
        <form id="ng-upload-form" method="POST" action="<?php echo e(route('gm.datafile-control.npcgen')); ?>" enctype="multipart/form-data" style="display:grid;gap:.8rem;max-width:760px;">
            <?php echo csrf_field(); ?>
            <div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="pw-adm-card" style="padding:1rem 1.2rem;">
        <div style="display:flex;justify-content:space-between;align-items:center;gap:1rem;flex-wrap:wrap;margin-bottom:.8rem;">
            ...
            <div style="font-size:.74rem;color:var(--pw-text-muted);">Terakhir 20 aktivitas</div>
        </div>
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $npcgenLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            ...
                            <td style="padding:.55rem;border-bottom:1px solid var(--pw-border);font-size:.78rem;"><?php echo e($row->actor_name); ?> <span style="color:var(--pw-text-muted);">(<?php echo e(strtoupper((string) $row->actor_role)); ?>)</span></td>
...
<?php echo $__env->make('layouts.gm', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pw-panel/resources/views/gm/datafile-control.blade.php ENDPATH**/ ?>