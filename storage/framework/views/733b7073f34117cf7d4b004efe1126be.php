<?php $__env->startSection('title', 'Dashboard Partner'); ?>
...
<div id="partner-referral-card"
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:.75rem;">
        <div>
            ...
            <div style="display:flex;align-items:center;gap:.6rem;">
                <div class="ref-code" style="font-family:monospace;font-size:1.4rem;font-weight:700;color:#22c55e;letter-spacing:.1em;">
                    <?php echo e(auth()->user()->referral_code); ?>

                </div>
                <button @click="copyText('<?php echo e(auth()->user()->referral_code); ?>', 'code')"
                        class="ref-copy-btn"
        ...
        <div style="text-align:right;">
            ...
            <span style="font-size:.85rem;color:var(--pw-gold);font-weight:600;"><?php echo e($partner->label); ?></span>
        </div>
    </div>
    ...
    <div class="ref-divider" style="margin-top:1rem;padding-top:.8rem;border-top:1px solid rgba(34,197,94,.15);">
        ...
        <div style="display:flex;align-items:center;gap:.5rem;">
            ...
            <button @click="copyText('<?php echo e(route('register', ['ref' => auth()->user()->referral_code])); ?>', 'link')"
                    class="ref-copy-btn"
...
<div style="background:linear-gradient(135deg,rgba(200,151,42,.08),rgba(200,151,42,.02));
     ...
     x-data="{
        editing: false,
        code: '<?php echo e($partner->discount_code ?? ''); ?>',
        saving: false,
        message: '',
        msgType: '',
        copiedDC: false,
        save() {
            this.saving = true;
            this.message = '';
            fetch('<?php echo e(route('partner.discount-code.update')); ?>', {
                method: 'PUT',
...
<div class="pw-partner-stats-grid" style="display:grid;grid-template-columns:repeat(6,1fr);gap:1rem;margin-bottom:1.5rem;">
    <div class="pw-adm-stat">
        ...
        <div class="pw-adm-stat__value"><?php echo e(number_format($totalReferrals)); ?></div>
    ...
    <div class="pw-adm-stat">
        ...
        <div class="pw-adm-stat__value"><?php echo e($currencyLabel === 'IDR' ? 'Rp ' : ''); ?><?php echo e(number_format($totalCommission)); ?> <span style="font-size:.65rem;color:var(--pw-text-muted);"><?php echo e($currencyLabel !== 'IDR' ? $currencyLabel : ''); ?></span></div>
    ...
    <div class="pw-adm-stat">
        ...
        <div class="pw-adm-stat__value"><?php echo e($currencyLabel === 'IDR' ? 'Rp ' : ''); ?><?php echo e(number_format($pendingCommission)); ?> <span style="font-size:.65rem;color:var(--pw-text-muted);"><?php echo e($currencyLabel !== 'IDR' ? $currencyLabel : ''); ?></span></div>
    ...
    <div class="pw-adm-stat">
        ...
        <div class="pw-adm-stat__value"><?php echo e($currencyLabel === 'IDR' ? 'Rp ' : ''); ?><?php echo e(number_format($monthCommission)); ?> <span style="font-size:.65rem;color:var(--pw-text-muted);"><?php echo e($currencyLabel !== 'IDR' ? $currencyLabel : ''); ?></span></div>
    ...
    <div class="pw-adm-stat">
        ...
        <div class="pw-adm-stat__value" style="color:#38bdf8;"><?php echo e(number_format($totalReferrals)); ?></div>
    ...
    <div class="pw-adm-stat">
        ...
        <div class="pw-adm-stat__value" style="color:#f472b6;"><?php echo e(number_format($totalTransactions)); ?></div>
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1.5rem;">
    <div class="pw-adm-card" style="margin-bottom:0;">
        ...
        <div style="display:grid;gap:.5rem;font-size:.82rem;">
            <div style="display:flex;justify-content:space-between;">
                ...
                <span style="color:<?php echo e($partner->is_active ? '#22c55e' : '#ef4444'); ?>;"><?php echo e($partner->is_active ? 'Aktif' : 'Nonaktif'); ?></span>
            </div>
            <div style="display:flex;justify-content:space-between;">
                <span style="color:var(--pw-text-muted);">Reward per Referral</span>
                <span style="color:var(--pw-text);"><?php echo e(number_format($partner->reward_amount)); ?> <?php echo e($partner->reward_type === 'gold' ? 'Gold' : ($partner->reward_type === 'cubi' ? 'Cubi' : 'Rupiah')); ?></span>
            </div>
            <div style="display:flex;justify-content:space-between;">
                <span style="color:var(--pw-text-muted);">Min Level Karakter</span>
                <span style="color:var(--pw-text);">Lv. <?php echo e($partner->min_char_level); ?></span>
            </div>
            <div style="display:flex;justify-content:space-between;">
                <span style="color:var(--pw-text-muted);">Maks per Hari</span>
                <span style="color:var(--pw-text);"><?php echo e($partner->max_per_day); ?></span>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($partner->max_total): ?>
            <div style="display:flex;justify-content:space-between;">
                <span style="color:var(--pw-text-muted);">Maks Total</span>
                <span style="color:var(--pw-text);"><?php echo e(number_format($partner->max_total)); ?></span>
            </div>
    ...
    <div class="pw-adm-card" style="margin-bottom:0;"
         x-data="{
             editing: false,
             tiktok: '<?php echo e(addslashes($partner->link_tiktok ?? '')); ?>',
             youtube: '<?php echo e(addslashes($partner->link_youtube ?? '')); ?>',
             facebook: '<?php echo e(addslashes($partner->link_facebook ?? '')); ?>',
             saving: false,
             message: '',
             msgType: '',
             save() {
                 this.saving = true; this.message = '';
                 fetch('<?php echo e(route('partner.social-media.update')); ?>', {
                     method: 'PUT',
                     headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>', 'Accept': 'application/json' },
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($partner->notes): ?>
        <div style="margin-top:1rem;padding-top:.8rem;border-top:1px solid var(--pw-border);">
            ...
            <div style="font-size:.78rem;color:var(--pw-text);"><?php echo e($partner->notes); ?></div>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
</div>
        ...
        <table class="pw-table">
            <thead>
                <tr>
                    ...
                    <th style="text-align:right;">Komisi (<?php echo e($currencyLabel); ?>)</th>
            ...
            <tbody>
                ...
                <tr>
                    <td style="font-family:monospace;"><?php echo e($tx->invoice_number); ?></td>
                    <td><?php echo e($tx->user->name ?? '-'); ?></td>
                    <td style="font-family:monospace;font-size:.78rem;color:var(--pw-gold);"><?php echo e($tx->refcode ?: '—'); ?></td>
                    <td style="text-align:right;">Rp <?php echo e(number_format($tx->amount, 0, ',', '.')); ?></td>
                    <td style="text-align:right;color:var(--pw-text-muted);"><?php echo e($tx->commission_percent); ?>%</td>
                    <td style="text-align:right;color:#22c55e;font-weight:600;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currencyLabel === 'IDR'): ?>
                            Rp <?php echo e(number_format($tx->commission_amount, 0, ',', '.')); ?>

                        <?php elseif($currencyLabel === 'Cubi'): ?>
                            <?php echo e(number_format((int) floor($tx->commission_amount / config('pw-config.currency.cubi_rate_idr', 1000)))); ?>

                        <?php else: ?>
                            <?php echo e(number_format((int) floor($tx->commission_amount / config('pw-config.currency.rate_idr', 10000)))); ?>
                    ...
                    <td style="text-align:right;font-size:.78rem;color:var(--pw-text-muted);"><?php echo e($tx->paid_at?->format('d M Y H:i') ?? '-'); ?></td>
                </tr>
...
<?php echo $__env->make('layouts.partner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pw-panel/resources/views/partner/dashboard.blade.php ENDPATH**/ ?>