...
<?php $__env->startSection('title', 'Referral Ranking — ' . $__siteName); ?>
<?php $__env->startSection('meta_description', 'Lihat ranking referral pre-register ' . $__siteName . '. Ajak teman bermain dan dapatkan Cubi Gold gratis!'); ?>
...
<div class="pw-page-hero">
    ...
    <div class="pw-page-hero__inner" style="position:relative;z-index:1;">
        ...
        <p class="pw-page-hero__sub"><?php echo e($event->title ?? 'Pre-Register Event'); ?> — <?php echo e($__siteName); ?></p>
...
<section class="pw-section" id="ranking">
    <div class="pw-section__inner pw-section__inner--narrow">
        ...
        <div class="pw-card" style="text-align:center;padding:3rem;">
            ...
            <a href="<?php echo e(route('promo.launch')); ?>" class="pw-btn pw-btn--gold pw-btn--sm" style="margin-top:1rem;">Lihat Pre-Register</a>
        </div>
        <?php else: ?>

        
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($referrers->count() >= 3 && $referrers->currentPage() === 1): ?>
        <div class="pw-podium">
            <?php
                $podiumOrder  = [1, 0, 2];
                $podiumRank   = [2, 1, 3];
            ...
            <div class="pw-podium__item <?php echo e($podiumClass[$idx]); ?>">
                ...
                <div class="pw-podium__name"><?php echo e($r->name); ?></div>
                ...
                <div class="pw-podium__exp">
                    <span style="color:#4ade80;"><?php echo e($r->qualified_count); ?></span>
            ...
            <table class="pw-ranking__table">
                <thead>
                    <tr>
                        ...
                        <th style="text-align:center;">Qualified (Lv.<?php echo e($event->referral_req_level); ?>)</th>
                        <th style="text-align:center;">Detail</th>
                    </tr>
                </thead>
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $referrers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $referrer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php $rank = $referrers->firstItem() + $index; ?>
                    <tr class="<?php echo e($rank <= 3 ? 'pw-ranking__top' : ''); ?>" x-data="{ open: false }">
                        <td style="text-align:center;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rank <= 3): ?>
                                <span class="pw-rank pw-rank--<?php echo e($rank); ?>"><?php echo e($rank); ?></span>
                            <?php else: ?>
                                <span class="pw-rank"><?php echo e($rank); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                        <td class="pw-ranking__name"><?php echo e($referrer->name); ?></td>
                        <td style="text-align:center;font-family:monospace;font-size:.82rem;color:var(--pw-text-muted);"><?php echo e($referrer->referral_code); ?></td>
                        <td style="text-align:center;">
                            <span style="font-weight:800;color:#c8972a;font-size:1.05rem;"><?php echo e($referrer->referral_count); ?></span>
                        </td>
                        <td style="text-align:center;">
                            <span style="font-weight:700;color:<?php echo e($referrer->qualified_count > 0 ? '#4ade80' : 'var(--pw-text-muted)'); ?>;"><?php echo e($referrer->qualified_count); ?></span>
                            <span style="color:var(--pw-text-muted);font-size:.78rem;"> / <?php echo e($referrer->referral_count); ?></span>
                        </td>
                        <td style="text-align:center;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($referrer->referred_users->count() > 0): ?>
                            <button @click="open = !open" style="background:none;border:1px solid rgba(200,151,42,.2);border-radius:6px;padding:.2rem .6rem;cursor:pointer;color:var(--pw-text-muted);font-size:.75rem;transition:all .2s;" :style="open ? 'background:rgba(200,151,42,.1);color:#c8972a;border-color:#c8972a;' : ''">
                                ...
                                <?php echo e($referrer->referred_users->count()); ?>
                    ...
                    <tr x-show="open" x-collapse style="background:rgba(200,151,42,.02);">
                        <td colspan="6" style="padding:.6rem 1rem .8rem;">
                            <div style="display:flex;flex-wrap:wrap;gap:.4rem;">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $referrer->referred_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ru): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <span style="display:inline-flex;align-items:center;gap:.3rem;padding:.25rem .6rem;border-radius:6px;font-size:.78rem;
                                    <?php echo e($ru->level_ok ? 'background:rgba(74,222,128,.08);border:1px solid rgba(74,222,128,.15);color:#4ade80;' : 'background:rgba(148,163,184,.05);border:1px solid rgba(148,163,184,.1);color:var(--pw-text-muted);'); ?>">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ru->level_ok): ?>
                                    ...
                                    <span style="font-size:.7rem;opacity:.6;">Lv.<?php echo e($ru->level); ?></span>
                                </span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </div>
                        </td>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($referrers->hasPages()): ?>
        ...
        <div style="text-align:center;margin-top:1.5rem;padding:1rem;font-size:.78rem;color:var(--pw-text-muted);">
            <div>
                ...
                &bull; Syarat: Karakter min. Level <?php echo e($event->referral_req_level); ?>

                &bull; <?php echo e(number_format($totalRegistered)); ?> user terdaftar
            </div>
            <div style="margin-top:.5rem;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('profile')); ?>" class="pw-btn pw-btn--gold pw-btn--sm" style="font-size:.78rem;">Lihat Kode Referral Saya</a>
                <?php else: ?>
                <a href="<?php echo e(route('register')); ?>" class="pw-btn pw-btn--gold pw-btn--sm" style="font-size:.78rem;">Daftar & Mulai Invite Teman</a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pw-panel/resources/views/website/referral-ranking.blade.php ENDPATH**/ ?>