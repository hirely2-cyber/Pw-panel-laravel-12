    ...
    <div class="pw-hero__content">
        ...
        <div class="pw-hero__stats-row">
            <div class="pw-hero__stat-item">
                ...
                <strong id="hero-accounts" class="pw-hero__stat-val" data-target="<?php echo e(\App\Models\User::where('role', 'player')->count()); ?>">0</strong>
            </div>
...
<section class="pw-features">
    <div class="pw-features__inner">
        ...
        <a href="<?php echo e(route('shop')); ?>" class="pw-feature-card">
            ...
            <h3><?php echo e(__('main.feature_shop')); ?></h3>
            <p><?php echo e(__('main.feature_shop_desc')); ?></p>
        </a>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <a href="<?php echo e(route('cubi-shop')); ?>" class="pw-feature-card">
            <div class="pw-feature-card__icon">
                <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h3><?php echo e(__('main.feature_donate')); ?></h3>
            <p><?php echo e(__('main.feature_donate_desc')); ?></p>
        </a>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <a href="<?php echo e(route('vote')); ?>" class="pw-feature-card">
            <div class="pw-feature-card__icon">
                <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h3><?php echo e(__('main.feature_vote')); ?></h3>
            <p><?php echo e(__('main.feature_vote_desc')); ?></p>
        </a>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <a href="<?php echo e(route('ranking')); ?>" class="pw-feature-card">
            <div class="pw-feature-card__icon">
                <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h3><?php echo e(__('main.feature_ranking')); ?></h3>
            <p><?php echo e(__('main.feature_ranking_desc')); ?></p>
        </a>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <a href="<?php echo e(route('services')); ?>" class="pw-feature-card">
            <div class="pw-feature-card__icon">
                <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h3><?php echo e(__('main.feature_service')); ?></h3>
            <p><?php echo e(__('main.feature_service_desc')); ?></p>
        </a>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <a href="<?php echo e(route('voucher')); ?>" class="pw-feature-card">
            <div class="pw-feature-card__icon">
                <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h3><?php echo e(__('main.feature_voucher')); ?></h3>
            <p><?php echo e(__('main.feature_voucher_desc')); ?></p>
        </a>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
</section>
