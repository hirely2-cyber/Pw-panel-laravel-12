...
<section class="pw-hero" id="hero">
    ...
    <div class="pw-hero__bg" aria-hidden="true">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($heroBg): ?>
            <img src="<?php echo e(Storage::url($heroBg)); ?>" class="pw-hero__bg-img" alt="" fetchpriority="high" loading="eager">
        <?php else: ?>
                    ...
                    <div class="pw-discord-card__body">
                        <div class="pw-discord-card__server">
                            ...
                            <span class="pw-discord-card__status">
                                ...
                                <span x-text="onlineCount + ' <?php echo e(__('main.discord_online')); ?>'">0 online</span>
                            </span>
                        </div>
                        ...
                        <div class="pw-discord-card__members">
                            ...
                            <template x-if="members.length === 0">
                                <p class="pw-discord-card__empty"><?php echo e(__('main.discord_no_members')); ?></p>
                            </template>
                        </div>
                        ...
                        <a :href="inviteUrl || 'https://discord.gg/7xCWyB2NFy'" target="_blank" rel="noopener"
                           class="pw-btn pw-btn--gold pw-discord-card__join">
                            ...
                            <?php echo e(__('main.discord_join')); ?>
