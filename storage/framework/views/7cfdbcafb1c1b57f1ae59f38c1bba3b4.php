<?php $__env->startSection('title', $item->exists ? 'Edit Item Shop' : 'Tambah Item Shop'); ?>

<?php $__env->startSection('content'); ?>
<form action="<?php echo e($item->exists ? route('admin.shop.update', $item->id) : route('admin.shop.store')); ?>"
    ...
    <div style="display:grid;grid-template-columns:2fr 1fr;gap:1.5rem;align-items:start;">
        ...
        <div class="pw-adm-card">
            ...
            <input type="text" name="name" class="pw-form__input" required
                   value="<?php echo e(old('name', $item->name)); ?>" style="margin-bottom:.8rem;">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <textarea name="description" rows="4" class="pw-form__input" style="resize:vertical;height:auto;"><?php echo e(old('description', $item->description)); ?></textarea>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:.8rem;margin-top:.8rem;">
                <div>
                    ...
                    <input type="text" name="category" class="pw-form__input" required
                           value="<?php echo e(old('category', $item->category)); ?>" list="cat-list">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:.8rem;margin-top:.8rem;">
                <div>
                    ...
                    <input type="number" name="item_id" class="pw-form__input" min="0"
                           value="<?php echo e(old('item_id', $item->item_id ?? 0)); ?>">
                ...
                <div>
                    ...
                    <input type="number" name="item_count" class="pw-form__input" min="1"
                           value="<?php echo e(old('item_count', $item->item_count ?? 1)); ?>">
            ...
            <div style="margin-top:.8rem;">
                ...
                <input type="number" name="sort_order" class="pw-form__input" min="0"
                       value="<?php echo e(old('sort_order', $item->sort_order ?? 0)); ?>" style="max-width:120px;">
            ...
            <div class="pw-adm-card">
                ...
                <div style="display:flex;gap:.5rem;">
                    <button type="submit" class="pw-adm-btn" style="flex:1;">
                        <?php echo e($item->exists ? 'Simpan' : 'Tambahkan'); ?>

                    </button>
                    <a href="<?php echo e(route('admin.shop.index')); ?>" class="pw-adm-btn pw-adm-btn--ghost">Batal</a>
                </div>
            </div>
            ...
            <div class="pw-adm-card">
                ...
                <div class="pw-img-upload" id="img-wrap">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->image): ?>
                        <img src="<?php echo e(Storage::url($item->image)); ?>" class="pw-img-upload__preview" id="img-preview" alt="">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pw-panel/resources/views/admin/shop/form.blade.php ENDPATH**/ ?>