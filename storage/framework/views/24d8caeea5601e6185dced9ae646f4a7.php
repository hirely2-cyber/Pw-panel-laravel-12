<?php $__env->startSection('title', 'Konten Website'); ?>

<?php $__env->startSection('content'); ?>


<div style="display:flex;gap:.5rem;margin-bottom:1.25rem;">
    <a href="<?php echo e(route('admin.settings')); ?>" class="pw-btn pw-btn--gold" style="font-size:.8rem;padding:.45rem .9rem;">
    ...
    <a href="<?php echo e(route('admin.settings.panel')); ?>" class="pw-btn pw-settings-tab--inactive" style="font-size:.8rem;padding:.45rem .9rem;">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                ...
                <?php $authBg = $settings->get('site_auth_bg'); ?>
                <div class="pw-img-upload" id="auth-upload-wrap" style="aspect-ratio:16/5;min-height:unset;">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($authBg): ?>
                        <img src="<?php echo e(Storage::url($authBg)); ?>" class="pw-img-upload__preview" id="auth-bg-preview" alt="Auth BG">
                        <div class="pw-img-upload__label">Klik untuk ganti gambar</div>
                        <label class="pw-img-upload__remove" onclick="event.stopPropagation()">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['site_auth_bg'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div style="margin-top:1.25rem;">
            ...
            <?php $footerLogo = $settings->get('site_footer_logo'); ?>
            <div class="pw-img-upload" id="footer-logo-upload-wrap" style="aspect-ratio:4/1;min-height:unset;">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($footerLogo): ?>
                    <img src="<?php echo e(Storage::url($footerLogo)); ?>" class="pw-img-upload__preview" id="footer-logo-preview" alt="Footer Logo" style="max-height:70px;object-fit:contain;background:rgba(0,0,0,.3);padding:.5rem;border-radius:4px;">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['site_footer_logo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
    ...
    <div class="pw-adm-card" style="margin-bottom:1.25rem;">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem;">
            <div class="pw-form__group">
                ...
                <input type="text" name="site_name" class="pw-form__input" maxlength="50"
                    value="<?php echo e($settings->get('site_name', '')); ?>"
            ...
            <div class="pw-form__group">
                ...
                <input type="text" name="site_tagline" class="pw-form__input" maxlength="50"
                    value="<?php echo e($settings->get('site_tagline', '')); ?>"
        ...
        <div class="pw-form__group" style="margin-bottom:1rem;">
            ...
            <textarea name="site_description" id="site-desc-input" class="pw-form__input" rows="3" maxlength="200"
                ...
                style="resize:vertical;"><?php echo e($settings->get('site_description', '')); ?></textarea>
        ...
        <div style="display:grid;grid-template-columns:1fr;gap:1rem;margin-bottom:1rem;">
            ...
            <div class="pw-form__group">
                ...
                <input type="text" name="seo_google_verification" class="pw-form__input"
                    value="<?php echo e($settings->get('seo_google_verification', '')); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pw-panel/resources/views/admin/settings/content.blade.php ENDPATH**/ ?>