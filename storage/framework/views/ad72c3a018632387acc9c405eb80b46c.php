<?php $__env->startSection('title', 'Pengaturan Partner'); ?>
...
<div style="display:flex;gap:.5rem;margin-bottom:1.25rem;">
    ...
    <a href="<?php echo e(route('admin.referral.partners')); ?>" class="pw-btn pw-btn--gold" style="font-size:.8rem;padding:.45rem .9rem;">
...
<div class="pw-adm-card" style="margin-bottom:1.25rem;">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:.5rem;margin-bottom:1.25rem;padding-bottom:.75rem;border-bottom:1px solid rgba(255,255,255,.07);">
        ...
        <label style="display:flex;align-items:center;gap:.5rem;cursor:pointer;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.09);border-radius:6px;padding:.45rem .8rem;">
            <input type="checkbox" name="enabled" value="1" form="formReferralSettings"
                <?php echo e(config('pw-config.referral.enabled') ? 'checked' : ''); ?>
    ...
    <form id="formReferralSettings" method="POST" action="<?php echo e(route('admin.referral.settings')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1.25rem;">
            <div>
                ...
                <select name="reward_type" class="pw-adm-input" style="margin-top:.25rem;">
                    <option value="gold" <?php echo e(config('pw-config.referral.reward_type','gold') === 'gold' ? 'selected' : ''); ?>>Gold Points (Saldo Panel)</option>
                    <option value="cubi" <?php echo e(config('pw-config.referral.reward_type','gold') === 'cubi' ? 'selected' : ''); ?>>Cubi Gold (In-Game)</option>
                </select>
            ...
            <div>
                ...
                <input type="number" name="reward_amount" class="pw-adm-input" style="margin-top:.25rem;"
                    value="<?php echo e(config('pw-config.referral.reward_gold', 10)); ?>" min="1" max="999999">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1.25rem;padding:.85rem;background:rgba(255,255,255,.025);border-radius:.5rem;border:1px solid rgba(255,255,255,.07);">
            <div>
                ...
                <select name="referred_reward_type" class="pw-adm-input" style="margin-top:.25rem;">
                    <option value="none" <?php echo e(config('pw-config.referral.referred_reward_type','none') === 'none' ? 'selected' : ''); ?>>Tidak Ada</option>
                    <option value="gold" <?php echo e(config('pw-config.referral.referred_reward_type','none') === 'gold' ? 'selected' : ''); ?>>Gold Points (Saldo Panel)</option>
                    <option value="cubi" <?php echo e(config('pw-config.referral.referred_reward_type','none') === 'cubi' ? 'selected' : ''); ?>>Cubi Gold (In-Game)</option>
                </select>
            ...
            <div>
                ...
                <input type="number" name="referred_reward_amount" class="pw-adm-input" style="margin-top:.25rem;"
                    value="<?php echo e(config('pw-config.referral.referred_reward_amount', 0)); ?>" min="0" max="999999">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:1rem;margin-bottom:1.25rem;">
            <div>
                ...
                <input type="number" name="min_char_level" class="pw-adm-input" style="margin-top:.25rem;"
                    value="<?php echo e(config('pw-config.referral.min_char_level', 1)); ?>" min="1" max="150">
            ...
            <div>
                ...
                <select name="min_cultivation" class="pw-adm-input" style="margin-top:.25rem;">
                    ...
                    ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $cultivations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <option value="<?php echo e($val); ?>" <?php echo e($currentCult === $val ? 'selected' : ''); ?>><?php echo e($val === 0 ? $label : $val . ' – ' . $label); ?></option>
            ...
            <div>
                ...
                <input type="number" name="max_per_day" class="pw-adm-input" style="margin-top:.25rem;"
                    value="<?php echo e(config('pw-config.referral.max_per_day', 0)); ?>" min="0" max="10000">
                <p style="font-size:.7rem;color:var(--pw-text-muted);margin-top:.3rem;">
...
<div class="pw-adm-card" style="margin-bottom:1.25rem;">
    ...
    <div class="pw-table-wrap">
        <table class="pw-table">
            ...
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <tr>
                    <td>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->user): ?>
                        <a href="<?php echo e(route('admin.members.show', $p->user->ID)); ?>" style="color:var(--pw-gold-light);font-weight:600;"><?php echo e($p->user->name); ?></a>
                        <?php else: ?>
                        <span style="color:var(--pw-text-muted);">-</span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </td>
                    <td><span class="pw-badge" style="background:rgba(168,85,247,.15);color:#c084fc;"><?php echo e($p->label); ?></span></td>
                    <td>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->discount_code): ?>
                        <code style="background:rgba(200,151,42,.12);color:var(--pw-gold-light);padding:2px 6px;border-radius:4px;font-size:.78rem;"><?php echo e($p->discount_code); ?></code>
                        <?php else: ?>
                        <span style="color:var(--pw-text-muted);font-size:.75rem;">—</span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </td>
                    <td>
                        <strong style="color:var(--pw-gold-light);"><?php echo e(number_format($p->reward_amount)); ?></strong>
                        <span style="font-size:.7rem;color:var(--pw-text-muted);"><?php echo e($p->reward_type === 'cubi' ? 'Cubi' : ($p->reward_type === 'tunai' ? 'Rp' : 'Gold')); ?></span>
                    </td>
                    <td style="text-align:center;">Lv.<?php echo e($p->min_char_level); ?></td>
                    <td style="text-align:center;"><?php echo e($p->max_per_day); ?></td>
                    <td style="text-align:center;"><?php echo e($p->max_total ? number_format($p->max_total) : '&infin;'); ?></td>
                    <td style="text-align:center;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->ip_unique_only): ?>
                    ...
                    <td style="text-align:center;">
                        <span style="color:#7deba0;font-weight:600;"><?php echo e($p->total_rewarded); ?></span>
                        <span style="color:var(--pw-text-muted);">/<?php echo e($p->total_referrals); ?></span>
                    </td>
                    <td style="text-align:center;">
                        <strong style="color:var(--pw-gold-light);"><?php echo e(number_format($p->total_earned)); ?></strong>
                    </td>
                    <td>
                    ...
                    <td>
                        <div style="display:flex;gap:.35rem;align-items:center;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->link_tiktok): ?>
                            <a href="<?php echo e($p->link_tiktok); ?>" target="_blank" rel="noopener" title="TikTok" style="color:#ee1d52;line-height:1;">
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->link_youtube): ?>
                            <a href="<?php echo e($p->link_youtube); ?>" target="_blank" rel="noopener" title="YouTube" style="color:#ff0000;line-height:1;">
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->link_facebook): ?>
                            <a href="<?php echo e($p->link_facebook); ?>" target="_blank" rel="noopener" title="Facebook" style="color:#1877f2;line-height:1;">
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$p->link_tiktok && !$p->link_youtube && !$p->link_facebook): ?>
                    ...
                    <td>
                        <div style="display:flex;gap:.3rem;align-items:center;">
                            <button type="button" class="pw-adm-btn pw-adm-btn--sm pw-adm-btn--ghost"
                                onclick="openEditPartner(<?php echo e(json_encode($p)); ?>)">Edit</button>
                            <form action="<?php echo e(route('admin.referral.partner.delete', $p->id)); ?>" method="POST"
...
<div class="pw-adm-card">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem;flex-wrap:wrap;gap:.6rem;">
        <div style="display:flex;align-items:center;gap:.6rem;">
            ...
            <span class="pw-badge pw-badge--warning" style="font-size:.7rem;"><?php echo e($pendingCount); ?> pending</span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
    ...
    <div class="pw-table-wrap">
        <table class="pw-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($app->user): ?>
                        <a href="<?php echo e(route('admin.members.show', $app->user->ID)); ?>" style="color:var(--pw-gold-light);font-weight:600;"><?php echo e($app->user->name); ?></a>
                        <div style="font-size:.68rem;color:var(--pw-text-muted);"><?php echo e($app->user->email); ?></div>
                        <?php else: ?>
                        <span style="color:var(--pw-text-muted);">—</span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </td>
                    <td>
                        <a href="<?php echo e($app->channel_url); ?>" target="_blank" rel="noopener" style="color:#60a5fa;font-size:.82rem;"><?php echo e($app->channel_name); ?></a>
                    </td>
                    <td><span class="pw-badge" style="background:rgba(168,85,247,.15);color:#c084fc;text-transform:capitalize;"><?php echo e($app->platform); ?></span></td>
                    <td style="text-align:center;"><?php echo e(number_format($app->followers_count)); ?></td>
                    <td style="max-width:160px;font-size:.78rem;color:var(--pw-text-muted);"><?php echo e(Str::limit($app->reason, 60)); ?></td>
                    <td style="font-size:.75rem;color:var(--pw-text-muted);white-space:nowrap;"><?php echo e($app->created_at->format('d M Y H:i')); ?></td>
                    <td>
                    ...
                    <td>
                        ...
                        <div style="display:flex;gap:.3rem;align-items:center;">
                            <button type="button" class="pw-adm-btn pw-adm-btn--sm" style="background:rgba(34,197,94,.15);color:#22c55e;border-color:rgba(34,197,94,.3);"
                                    onclick="openApproveModal(<?php echo e(json_encode($app)); ?>)">Terima</button>
                            <button type="button" class="pw-adm-btn pw-adm-btn--sm pw-adm-btn--ghost" style="color:#e05252;"
                                    onclick="openRejectModal(<?php echo e($app->id); ?>)">Tolak</button>
                        </div>
                        <?php else: ?>
                        <div style="font-size:.72rem;color:var(--pw-text-muted);">
                            <?php echo e($app->reviewed_at?->format('d M Y')); ?>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($app->admin_notes): ?>
                            <div style="margin-top:.2rem;font-style:italic;"><?php echo e(Str::limit($app->admin_notes, 40)); ?></div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </td>
...
<div id="addPartnerModal" style="display:none;position:fixed;inset:0;z-index:999;background:rgba(0,0,0,.6);align-items:center;justify-content:center;">
    <div class="pw-adm-card" style="width:100%;max-width:480px;max-height:90vh;overflow-y:auto;">
        ...
        <form method="POST" action="<?php echo e(route('admin.referral.partner.add')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div style="margin-bottom:.7rem;padding:.6rem .8rem;background:rgba(184,157,79,.06);border:1px solid rgba(184,157,79,.15);border-radius:6px;font-size:.72rem;color:var(--pw-text-muted);">
                ...
                Gold Points: 1 Gold = Rp <?php echo e(number_format(config('pw-config.currency.rate_idr', 10000), 0, ',', '.')); ?> &nbsp;&middot;&nbsp;
                Cubi Gold: 1 Cubi = Rp <?php echo e(number_format(config('pw-config.currency.cubi_rate_idr', 1000), 0, ',', '.')); ?> &nbsp;&middot;&nbsp;
...
function userSearch() {
    return {
        ...
        async search() {
            ...
            this.loading = true;
            try {
                const res = await fetch('<?php echo e(route("admin.api.users.search")); ?>?q=' + encodeURIComponent(this.query));
...
function openApproveModal(app) {
    ...
    document.getElementById('approveAppForm').action = '<?php echo e(url("admin/referral/application")); ?>/' + app.id + '/approve';
}

function openRejectModal(appId) {
    document.getElementById('rejectAppModal').style.display = 'flex';
    document.getElementById('rejectAppForm').action = '<?php echo e(url("admin/referral/application")); ?>/' + appId + '/reject';
}
...
function openEditPartner(p) {
    ...
    document.getElementById('editPartnerForm').action = '<?php echo e(url("admin/referral/partner")); ?>/' + p.id;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pw-panel/resources/views/admin/referral/partners.blade.php ENDPATH**/ ?>