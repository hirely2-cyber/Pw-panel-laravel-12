...
<?php $__env->startSection('title', 'Pre-Register & Claim Exclusive Rewards — ' . $__siteName); ?>
<?php $__env->startSection('meta_description', 'Daftar sekarang di ' . $__siteName . '! Dapatkan hadiah eksklusif untuk pemain baru — mount langka, fashion set, gold & cubi gratis.'); ?>
...
<section class="pw-landing-hero">
    <div class="pw-landing-hero__bg" aria-hidden="true">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($__heroBg): ?>
            <img src="<?php echo e(Storage::url($__heroBg)); ?>" alt="" loading="eager" fetchpriority="high">
    ...
    <div class="pw-landing-hero__content">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($__heroLogo): ?>
            <img src="<?php echo e(Storage::url($__heroLogo)); ?>" alt="<?php echo e($__siteName); ?>" class="pw-landing-hero__logo">
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <p class="pw-landing-hero__sub">
            Jadilah bagian dari petualangan epik di <strong><?php echo e($__siteName); ?></strong>.<br>
        ...
        <a href="<?php echo e(route('register')); ?>" class="pw-landing-cta">
    ...
    <div class="pw-landing-section-inner">
        ...
        <div class="pw-landing-tiers">
            ...
            <div class="pw-landing-tier pw-landing-tier--bronze">
                ...
                <a href="<?php echo e(route('register')); ?>" class="pw-landing-tier__btn">Daftar Sekarang</a>
            </div>
            ...
            <div class="pw-landing-tier pw-landing-tier--silver">
                ...
                <?php $discord = \App\Models\Setting::get('social_discord'); ?>
                <a href="<?php echo e($discord ?: 'https://discord.gg/7xCWyB2NFy'); ?>" target="_blank" rel="noopener" class="pw-landing-tier__btn">Join Discord</a>
            </div>
            ...
            <div class="pw-landing-tier pw-landing-tier--gold">
                ...
                <a href="<?php echo e(route('register')); ?>" class="pw-landing-tier__btn">Daftar & Invite</a>
            </div>
        </div>
    </div>
</section>
...
<section class="pw-landing-features">
    <div class="pw-landing-section-inner">
        <h2 class="pw-landing-section-title">Kenapa <?php echo e($__siteName); ?>?</h2>
...
<section class="pw-landing-final-cta">
    <div class="pw-landing-section-inner" style="text-align:center;">
        ...
        <a href="<?php echo e(route('register')); ?>" class="pw-landing-cta pw-landing-cta--large">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pw-panel/resources/views/website/promo-launch.blade.php ENDPATH**/ ?>