<?php $__env->startSection('title', 'Character Roles'); ?>
...
<div style="display:grid;gap:1rem;">
        ...
        <div style="display:flex;justify-content:space-between;gap:1rem;flex-wrap:wrap;align-items:center;">
            <div>
                ...
                <div style="font-size:.78rem;color:var(--pw-text-muted);margin-top:.2rem;">
                    Total <strong style="color:var(--pw-text-light);"><?php echo e(number_format($totalRoles)); ?></strong> character terdaftar di database
                </div>
            </div>
    ...
    <div class="pw-adm-card" style="padding:1rem 1.2rem;">
        ...
        <div style="display:grid;grid-template-columns:repeat(6,1fr);gap:8px;">
            ...
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tplId => $tpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <a href="<?php echo e(route('admin.roles.show', $tplId)); ?>" style="display:flex;align-items:center;gap:8px;padding:8px 12px;border-radius:6px;border:1px solid rgba(255,255,255,.08);background:rgba(255,255,255,.03);color:var(--pw-text-light);text-decoration:none;font-size:.8rem;transition:all .15s;" onmouseover="this.style.background='rgba(240,165,0,.1)';this.style.borderColor='rgba(240,165,0,.3)'" onmouseout="this.style.background='rgba(255,255,255,.03)';this.style.borderColor='rgba(255,255,255,.08)'">
                    <img src="<?php echo e(asset('images/class/' . $tpl['icon'] . '.png')); ?>" style="width:22px;height:22px;border-radius:4px;" alt="">
                    <span style="font-weight:600;"><?php echo e($tpl['class']); ?></span>
                    <span style="margin-left:auto;opacity:.5;font-size:.72rem;"><?php echo e($tpl['race']); ?></span>
                </a>
    ...
    <div class="pw-adm-card" style="padding:.8rem 1.2rem;">
        <form method="GET" action="<?php echo e(route('admin.roles.index')); ?>" class="rl-search-wrap">
            <input type="text" name="search" value="<?php echo e($search); ?>" class="rl-input" style="flex:1;min-width:200px;" placeholder="Cari nama character...">
<?php ($selectedClassName = $classFilter !== '' && $classFilter !== null ? ($classMap[(int)$classFilter] ?? 'Semua Class') : 'Semua Class'); ?>
            <div x-data="{ open: false, cls: '<?php echo e($classFilter); ?>', label: '<?php echo e($selectedClassName); ?>' }" style="position:relative;" @click.away="open = false">
                ...
                <div x-show="open" x-transition.opacity.duration.150ms class="rl-dd-menu">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $classMap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <button type="button" @click="cls='<?php echo e($id); ?>'; label='<?php echo e($name); ?>'; open=false" class="rl-dd-item" :class="cls==='<?php echo e($id); ?>' && 'rl-dd-item--active'"><?php echo e($name); ?></button>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
            </div>
            <button type="submit" class="pw-adm-btn" style="font-size:.82rem;">Cari</button>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search || $classFilter): ?>
                <a href="<?php echo e(route('admin.roles.index')); ?>" style="font-size:.78rem;color:var(--pw-text-muted);text-decoration:none;">&times; Reset</a>
    ...
    <div class="pw-adm-card" style="padding:1rem 1.2rem;">
        <div style="overflow:auto;">
            <table style="width:100%;border-collapse:collapse;min-width:900px;">
                <thead>
                    <tr>
                        <th style="text-align:left;padding:.55rem;border-bottom:1px solid var(--pw-border);font-size:.72rem;color:var(--pw-text-muted);">
                            <a href="<?php echo e($sortUrl('role_id')); ?>" class="rl-sort-link <?php echo e($sortClass('role_id')); ?>">Role ID <?php echo e($sortIcon('role_id')); ?></a>
                        </th>
                        <th style="text-align:left;padding:.55rem;border-bottom:1px solid var(--pw-border);font-size:.72rem;color:var(--pw-text-muted);">
                            <a href="<?php echo e($sortUrl('role_name')); ?>" class="rl-sort-link <?php echo e($sortClass('role_name')); ?>">Character <?php echo e($sortIcon('role_name')); ?></a>
                        </th>
                        <th style="text-align:center;padding:.55rem;border-bottom:1px solid var(--pw-border);font-size:.72rem;color:var(--pw-text-muted);">
                            <a href="<?php echo e($sortUrl('role_level')); ?>" class="rl-sort-link <?php echo e($sortClass('role_level')); ?>">Level <?php echo e($sortIcon('role_level')); ?></a>
                        </th>
                        <th style="text-align:left;padding:.55rem;border-bottom:1px solid var(--pw-border);font-size:.72rem;color:var(--pw-text-muted);">
                            <a href="<?php echo e($sortUrl('role_occupation')); ?>" class="rl-sort-link <?php echo e($sortClass('role_occupation')); ?>">Class <?php echo e($sortIcon('role_occupation')); ?></a>
                        </th>
                        ...
                        <th style="text-align:left;padding:.55rem;border-bottom:1px solid var(--pw-border);font-size:.72rem;color:var(--pw-text-muted);">
                            <a href="<?php echo e($sortUrl('faction_name')); ?>" class="rl-sort-link <?php echo e($sortClass('faction_name')); ?>">Faction <?php echo e($sortIcon('faction_name')); ?></a>
                        </th>
                        <th style="text-align:center;padding:.55rem;border-bottom:1px solid var(--pw-border);font-size:.72rem;color:var(--pw-text-muted);">
                            <a href="<?php echo e($sortUrl('pvp_kills')); ?>" class="rl-sort-link <?php echo e($sortClass('pvp_kills')); ?>">PvP K/D <?php echo e($sortIcon('pvp_kills')); ?></a>
                        </th>
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            <td style="padding:.55rem;border-bottom:1px solid rgba(255,255,255,.06);font-size:.78rem;font-family:monospace;"><?php echo e($r->role_id); ?></td>
                            <td style="padding:.55rem;border-bottom:1px solid rgba(255,255,255,.06);font-size:.82rem;font-weight:600;"><?php echo e($r->role_name); ?></td>
                            <td style="padding:.55rem;border-bottom:1px solid rgba(255,255,255,.06);font-size:.82rem;text-align:center;font-weight:700;"><?php echo e($r->role_level); ?></td>
                            <td style="padding:.55rem;border-bottom:1px solid rgba(255,255,255,.06);font-size:.78rem;">
                                <div style="display:flex;align-items:center;gap:6px;">
                                    <img src="<?php echo e(asset('images/class/' . ($iconMap[$r->role_occupation] ?? 'blademaster') . '.png')); ?>" class="rl-class-icon" alt="">
                                    <?php echo e($classMap[$r->role_occupation] ?? 'Unknown'); ?>

                                </div>
                            </td>
                            <td style="padding:.55rem;border-bottom:1px solid rgba(255,255,255,.06);font-size:.78rem;"><?php echo e($raceMap[$r->role_race] ?? 'Unknown'); ?></td>
                            <td style="padding:.55rem;border-bottom:1px solid rgba(255,255,255,.06);font-size:.78rem;"><?php echo e($r->role_gender == 0 ? 'Male' : 'Female'); ?></td>
                            <td style="padding:.55rem;border-bottom:1px solid rgba(255,255,255,.06);font-size:.78rem;">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($r->faction_name): ?>
                                    <span class="rl-badge"><?php echo e($r->faction_name); ?> Lv.<?php echo e($r->faction_level); ?></span>
                                <?php else: ?>
                            ...
                            <td style="padding:.55rem;border-bottom:1px solid rgba(255,255,255,.06);font-size:.78rem;text-align:center;">
                                <span style="color:#50c878;"><?php echo e($r->pvp_kills); ?></span> / <span style="color:#ef4444;"><?php echo e($r->pvp_deads); ?></span>
                            </td>
                            <td style="padding:.55rem;border-bottom:1px solid rgba(255,255,255,.06);text-align:center;">
                                <a href="<?php echo e(route('admin.roles.show', $r->role_id)); ?>" class="pw-adm-btn" style="font-size:.74rem;padding:.25rem .5rem;">Detail</a>
                            </td>
                        </tr>
...
async function syncRoles() {
    ...
    fetch('<?php echo e(route("admin.roles.sync")); ?>', {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pw-panel/resources/views/admin/roles/index.blade.php ENDPATH**/ ?>