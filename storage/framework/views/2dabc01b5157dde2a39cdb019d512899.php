...
<div x-data="gmServerCtrl()" x-init="init()">
    ...
    <div class="pw-adm-card" style="padding:.9rem 1.2rem;margin-bottom:1rem;">
        <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:.6rem;">
            ...
            <div style="display:flex;flex-direction:column;gap:.18rem;">
                ...
                <span style="font-size:.82rem;font-weight:700;color:var(--pw-text-light);"><?php echo e($serverInfo['hostname']); ?></span>
            ...
            <div style="display:flex;flex-direction:column;gap:.18rem;">
                ...
                <span style="font-size:.82rem;font-weight:700;color:var(--pw-text-light);"><?php echo e($serverInfo['cpuCores']); ?> Core</span>
            ...
            <div style="display:flex;flex-direction:column;gap:.18rem;">
                ...
                <div style="display:flex;align-items:baseline;gap:.3rem;">
                    <span style="font-size:.82rem;font-weight:700;color:var(--pw-text-light);"><?php echo e($serverInfo['diskUsed']); ?></span>
            ...
            <div style="display:flex;flex-direction:column;gap:.18rem;">
                ...
                <span style="font-size:.82rem;font-weight:700;color:var(--pw-text-light);"><?php echo e(Str::after($serverInfo['uptime'], 'up ')); ?></span>
        ...
        <div class="pw-adm-card" style="padding:1.2rem;display:flex;flex-direction:column;gap:.9rem;">
            ...
            <div>
                ...
                <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:.35rem;margin-bottom:.6rem;">
                    ...
                    <div style="background:rgba(59,130,246,.08);border-radius:6px;padding:.4rem;text-align:center;">
                    ...
                    <div style="background:rgba(245,158,11,.08);border-radius:6px;padding:.4rem;text-align:center;">
                    ...
                    <div style="background:rgba(80,200,120,.06);border-radius:6px;padding:.4rem;text-align:center;">
                    ...
                    <template x-for="(d, key) in daemons" :key="key">
                        <div class="sc-daemon-row" style="display:flex;align-items:center;justify-content:space-between;padding:.38rem .65rem;border-radius:5px;background:rgba(255,255,255,.03);">
                            <div>
                                ...
                                <span style="font-size:.63rem;color:var(--pw-text-muted);font-family:monospace;margin-left:.4rem;" x-text="d.process"></span>
                            </div>
                ...
                <div style="display:flex;align-items:center;gap:.5rem;">
                    ...
                    <input type="number" x-model="stopAllDelay" min="0" max="3600" value="300"
                           ...
                           style="width:60px;background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.12);border-radius:5px;
                                  padding:.25rem .4rem;color:var(--pw-text);font-size:.75rem;text-align:center;">
...
<div class="pw-adm-card" style="padding:1rem 1.2rem;margin-top:1rem;">
    <div style="display:flex;justify-content:space-between;align-items:center;gap:1rem;flex-wrap:wrap;margin-bottom:.8rem;">
        ...
        <div style="font-size:.74rem;color:var(--pw-text-muted);">Menampilkan 50 aktivitas terbaru</div>
    </div>
        ...
        <table style="width:100%;border-collapse:collapse;min-width:920px;">
            ...
            <tbody>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <tr>
                        <td colspan="7" style="padding:1rem;border-bottom:1px solid var(--pw-border);font-size:.82rem;color:var(--pw-text-muted);text-align:center;">Belum ada aktivitas Server Control yang tercatat.</td>
                    </tr>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </tbody>
        </table>
...
/* ── Light mode overrides for gm server-control ── */
    ...
    return {
        ...
        async doAction(action, mapId) {
            ...
            try {
                ...
                const res  = await fetch('<?php echo e(route("gm.server-control.action")); ?>', { method: 'POST', body });
        ...
        async refreshStatus() {
            try {
                const data = await fetch('<?php echo e(route("gm.server-control.status")); ?>').then(r => r.json());
...
<?php echo $__env->make('layouts.gm', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pw-panel/resources/views/gm/server-control.blade.php ENDPATH**/ ?>