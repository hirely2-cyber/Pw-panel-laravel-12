...
<div style="margin-bottom:1rem;">
    <a href="<?php echo e(route('admin.events.index', ['tab' => $event->isPreLaunch() ? 'pre_launch' : 'grand_launch'])); ?>" class="pw-adm-btn pw-adm-btn--ghost pw-adm-btn--sm">← Kembali</a>
</div>
...
<div class="pw-adm-card">
    ...
    <form method="POST" action="<?php echo e(route('admin.events.update', $event)); ?>">
        ...
        <div style="margin-bottom:1rem;">
            ...
            <input type="text" name="title" class="pw-adm-input" value="<?php echo e(old('title', $event->title)); ?>" required>
        </div>

        <div style="margin-bottom:1rem;">
            <label class="pw-adm-label">Nama Event (EN)</label>
            <input type="text" name="title_en" class="pw-adm-input" value="<?php echo e(old('title_en', $event->title_en)); ?>" placeholder="English title">
        </div>

        <div style="margin-bottom:1rem;">
            <label class="pw-adm-label">Deskripsi (ID)</label>
            <textarea name="description" class="pw-adm-input" rows="3" style="resize:vertical;"><?php echo e(old('description', $event->description)); ?></textarea>
        </div>

        <div style="margin-bottom:1rem;">
            <label class="pw-adm-label">Deskripsi (EN)</label>
            <textarea name="description_en" class="pw-adm-input" rows="3" style="resize:vertical;" placeholder="English description"><?php echo e(old('description_en', $event->description_en)); ?></textarea>
        </div>
        ...
        <div style="margin-bottom:1rem;">
            ...
            <input type="number" name="referral_req_level" class="pw-adm-input" value="<?php echo e(old('referral_req_level', $event->referral_req_level)); ?>" min="1" max="150" required>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem;">
            <div>
                ...
                <input type="number" name="req_level" class="pw-adm-input" value="<?php echo e(old('req_level', $event->req_level)); ?>" min="1" max="150" required>
            </div>
            <div>
                ...
                <select name="req_cultivation" class="pw-adm-input">
                    ...
                    <option value="<?php echo e($val); ?>" <?php echo e(old('req_cultivation', $event->req_cultivation) == $val ? 'selected' : ''); ?>><?php echo e($val); ?> — <?php echo e($label); ?></option>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem;">
            <div>
                ...
                <input type="number" name="prize_total_cubi" class="pw-adm-input" value="<?php echo e(old('prize_total_cubi', $event->prize_total_cubi)); ?>" min="1" required>
            </div>
            <div>
                <label class="pw-adm-label">Jumlah Pemenang</label>
                <input type="number" name="prize_winner_count" class="pw-adm-input" value="<?php echo e(old('prize_winner_count', $event->prize_winner_count)); ?>" min="4" required>
            </div>
        </div>
        ...
        <div style="background:rgba(200,151,42,.06);border:1px solid rgba(200,151,42,.15);border-radius:8px;padding:1rem;margin-bottom:1rem;">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:.8rem;margin-bottom:.8rem;">
                <div>
                    ...
                    <input type="number" name="prize_rank1" class="pw-adm-input" value="<?php echo e(old('prize_rank1', $event->prize_rank1)); ?>" min="0">
                </div>
                <div>
                    <label class="pw-adm-label">Juara 2</label>
                    <input type="number" name="prize_rank2" class="pw-adm-input" value="<?php echo e(old('prize_rank2', $event->prize_rank2)); ?>" min="0">
                </div>
                <div>
                    <label class="pw-adm-label">Juara 3</label>
                    <input type="number" name="prize_rank3" class="pw-adm-input" value="<?php echo e(old('prize_rank3', $event->prize_rank3)); ?>" min="0">
                </div>
            </div>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1.5rem;">
            <div>
                ...
                <input type="datetime-local" name="start_at" class="pw-adm-input" value="<?php echo e(old('start_at', $event->start_at?->format('Y-m-d\TH:i'))); ?>" required>
            </div>
            <div>
                <label class="pw-adm-label">Tanggal Berakhir</label>
                <input type="datetime-local" name="end_at" class="pw-adm-input" value="<?php echo e(old('end_at', $event->end_at?->format('Y-m-d\TH:i'))); ?>" required>
            </div>
        </div>
...
function editTiers() {
    return {
        tiers: <?php echo json_encode(old('referral_tiers', $event->referral_tiers ?? [['count' => 10, 'reward' => 50]])) ?>,
    };
}
</script>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pw-panel/resources/views/admin/events/edit.blade.php ENDPATH**/ ?>