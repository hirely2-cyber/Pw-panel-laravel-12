<?php $__env->startSection('title', 'Game Mailer'); ?>

<?php $__env->startSection('content'); ?>
<div x-data="{ target: '<?php echo e(old('target', 'all')); ?>' }">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1.25rem;">
        ...
        <div class="pw-mailer-status" style="display:flex;align-items:center;gap:.5rem;padding:.4rem .8rem;border-radius:6px;">
            ...
            <span style="font-size:.78rem;color:var(--pw-text-muted);">gdeliveryd: <?php echo e($apiAvailable ? 'Connected' : 'Offline'); ?></span>
        </div>
    </div>
    ...
    <form action="<?php echo e(route('admin.mailer.send')); ?>" method="POST">
        <?php echo csrf_field(); ?>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:.8rem;">
                <div>
                    ...
                    <select name="target" class="pw-form__input" x-model="target">
                        <option value="all">Semua Karakter (<?php echo e(number_format($totalCharacters)); ?> karakter)</option>
                ...
                <div x-show="target === 'single'" x-cloak>
                    ...
                    <input type="number" name="role_id" class="pw-form__input" min="1"
                           value="<?php echo e(old('role_id')); ?>" placeholder="Contoh: 16">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div style="margin-bottom:.8rem;">
                ...
                <input type="text" name="title" class="pw-form__input" required maxlength="64"
                       value="<?php echo e(old('title')); ?>" placeholder="Hadiah Event Spesial">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:1rem;">
                <div>
                    ...
                    <input type="number" name="item_id" class="pw-form__input" min="0"
                           value="<?php echo e(old('item_id', 0)); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="number" name="item_count" class="pw-form__input" min="1" max="9999"
                           value="<?php echo e(old('item_count', 1)); ?>">
                ...
                <div>
                    ...
                    <input type="number" name="gold" class="pw-form__input" min="0"
                           value="<?php echo e(old('gold', 0)); ?>">
                    <p style="font-size:.72rem;color:var(--pw-text-muted);margin-top:.3rem;">0 = tanpa gold.</p>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['gold'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p style="color:#e05252;font-size:.75rem;margin-top:.3rem;"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;gap:1rem;">
                <label style="display:flex;align-items:center;gap:.5rem;cursor:pointer;font-size:.82rem;color:var(--pw-text-muted);">
                    ...
                    <span>Saya konfirmasi akan mengirim mail ini ke
                        <strong x-show="target === 'all'" style="color:var(--pw-text);">semua <?php echo e(number_format($totalCharacters)); ?> karakter</strong><strong x-show="target === 'single'" style="color:var(--pw-text);" x-cloak>karakter tertentu</strong>.
                    </span>
                </label>
            ...
            <div class="pw-adm-alert pw-adm-alert--error" style="margin-top:.75rem;font-size:.78rem;">
                Tidak dapat terhubung ke <strong>gdeliveryd</strong> (port <?php echo e(config('pw-api.ports.gdeliveryd', 29100)); ?>). Pastikan game server berjalan.
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </form>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pw-panel/resources/views/admin/mailer/index.blade.php ENDPATH**/ ?>