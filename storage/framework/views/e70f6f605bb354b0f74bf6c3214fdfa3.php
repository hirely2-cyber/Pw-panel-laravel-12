<?php $__env->startSection('title', __("main.auth_reset_title")); ?>
...
<div class="pw-auth">
    ...
    <div class="pw-auth__box">
        ...
        <div class="pw-auth__heading">
            <h1><?php echo e(__('main.auth_reset_title')); ?></h1>
            <div class="pw-auth__heading-line"><span class="pw-auth__heading-gem"></span></div>
        </div>

        <p class="pw-auth__desc"><?php echo e(__('main.auth_reset_subtitle')); ?></p>
            ...
            <div class="pw-form__group">
                ...
                <div class="pw-form__input-wrap">
                    ...
                    <input type="email" id="email" name="email"
                        ...
                        value="<?php echo e(old('email', $request->email)); ?>" required autocomplete="email"
                        placeholder="<?php echo e(__('main.auth_email_placeholder')); ?>" readonly>
                </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="pw-form__group">
                <label for="password" class="pw-form__label"><?php echo e(__('main.auth_reset_new_password')); ?></label>
                <div class="pw-form__input-wrap">
                    ...
                    <input type="password" id="password" name="password"
                        ...
                        placeholder="<?php echo e(__('main.auth_password_reg_placeholder')); ?>" autofocus>
                </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="pw-form__group">
                ...
                <div class="pw-form__input-wrap">
                    ...
                    <input type="password" id="password_confirmation" name="password_confirmation"
                        ...
                        placeholder="<?php echo e(__('main.auth_password_confirm_placeholder')); ?>">
                </div>
            </div>
            ...
            <button type="submit" class="pw-btn pw-btn--gold pw-btn--glow" style="width:100%;justify-content:center;">
                ...
                <?php echo e(__('main.auth_reset_btn')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pw-panel/resources/views/auth/reset-password.blade.php ENDPATH**/ ?>