<?php $__env->startSection('title', __('main.privacy_title')); ?>
...
<div style="max-width:900px;margin:3rem auto;padding:0 1.5rem;">
    <div style="background:var(--pw-bg-card);border:1px solid var(--pw-border);border-radius:12px;padding:2.5rem;">
        <div style="margin-bottom:2rem;">
            <h1 style="font-size:2rem;font-weight:700;margin-bottom:0.5rem;color:var(--pw-gold-light);"><?php echo e(__('main.privacy_title')); ?></h1>
        ...
        <div style="color:var(--pw-text);line-height:1.8;font-size:0.95rem;">
            <p style="margin-bottom:1.5rem;"><?php echo e(__('main.privacy_content')); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pw-panel/resources/views/website/privacy.blade.php ENDPATH**/ ?>